...
const T = {
  en: {
    ...
    card2_tag: "Solution 01", card2_title: "Retail Management System", card2_desc: "Synchronized inventory and point-of-sale operations.",
    ...
    j_tag: "Retail Management", j_title: "Retail Management System",
    j_intro: "Complete management platform for retail operations including inventory tracking, point-of-sale, vault management, and comprehensive reporting. Deployed as web application and desktop clients (Windows) with real-time data synchronization across all devices and approved accounts.",
  ...
  ar: {
    ...
    card2_tag: "حل 01", card2_title: "نظام إدارة البيع بالتجزئة", card2_desc: "عمليات المخزون ونقاط البيع المتزامنة.",
    ...
    j_tag: "إدارة البيع بالتجزئة", j_title: "نظام إدارة البيع بالتجزئة",
    j_intro: "منصة إدارة شاملة لعمليات البيع بالتجزئة تشمل تتبع المخزون ونقاط البيع وإدارة الخزنة والتقارير الشاملة. مطبّق كتطبيق ويب وعملاء سطح المكتب (Windows) مع مزامنة بيانات فورية عبر جميع الأجهزة والحسابات المصرح لها.",
